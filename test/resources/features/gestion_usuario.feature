Feature: Gestion completa del ciclo de vida de usuarios en la plataforma
  ...
  Scenario Outline: Crear, consultar, actualizar y eliminar un usuario exitosamente
    ...
    And consulto la informacion del usuario "<username>"
    ...
    And consulto nuevamente la informacion del usuario "<username>"
    ...
    Examples:
      ...
      | 0  | usuario3 | Carlos    | Lopez    | carlos.lopez@email.com   | password789 | 5551234567 | 1          | Carlos Alberto        | Lopez Martinez       | carlosalberto.lopez@email.com| newpassword789       |
